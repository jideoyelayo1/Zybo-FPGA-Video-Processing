...
HD_PWD='C:/Users/JideO/Documents/Programing_Projects/Zybo-FPGA-Video-Processing/sobel/sobel.runs/system_video_processing_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_video_processing_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_video_processing_0_0.tcl
