...
proc create_root_design { parentCell } {
  ...
  # Create instance: video_processing_0, and set properties
  set block_name video_processing
  set block_cell_name video_processing_0
  if { [catch {set video_processing_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $video_processing_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net PixelClk_Generator_clk_out1 [get_bd_pins DVIClocking_0/PixelClk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins rst_vid_clk_dyn/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins video_processing_0/clk] [get_bd_pins vtg/clk]
  ...
  connect_bd_net -net btn_0 [get_bd_ports btn] [get_bd_pins video_processing_0/btn]
  ...
  connect_bd_net -net sw_0 [get_bd_ports sw] [get_bd_pins video_processing_0/sw]
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins v_axi4s_vid_out_0/locked] [get_bd_pins video_processing_0/n_rst]
  connect_bd_net -net v_axi4s_vid_out_0_vid_active_video [get_bd_pins v_axi4s_vid_out_0/vid_active_video] [get_bd_pins video_processing_0/i_vid_VDE]
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins v_axi4s_vid_out_0/vid_data] [get_bd_pins video_processing_0/i_vid_data]
  connect_bd_net -net v_axi4s_vid_out_0_vid_hsync [get_bd_pins v_axi4s_vid_out_0/vid_hsync] [get_bd_pins video_processing_0/i_vid_hsync]
  connect_bd_net -net v_axi4s_vid_out_0_vid_vsync [get_bd_pins v_axi4s_vid_out_0/vid_vsync] [get_bd_pins video_processing_0/i_vid_vsync]
  ...
  connect_bd_net -net video_processing_0_led [get_bd_ports led] [get_bd_pins video_processing_0/led]
  connect_bd_net -net video_processing_0_o_vid_VDE [get_bd_pins rgb2dvi_0/vid_pVDE] [get_bd_pins video_processing_0/o_vid_VDE]
  connect_bd_net -net video_processing_0_o_vid_data [get_bd_pins rgb2dvi_0/vid_pData] [get_bd_pins video_processing_0/o_vid_data]
  connect_bd_net -net video_processing_0_o_vid_hsync [get_bd_pins rgb2dvi_0/vid_pHSync] [get_bd_pins video_processing_0/o_vid_hsync]
  connect_bd_net -net video_processing_0_o_vid_vsync [get_bd_pins rgb2dvi_0/vid_pVSync] [get_bd_pins video_processing_0/o_vid_vsync]
